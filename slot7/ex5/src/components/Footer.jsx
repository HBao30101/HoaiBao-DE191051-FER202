...
export default function Footer() {
  ...
  return (
    ...
    <footer className="text-dark py-4" style={{ backgroundColor: '#e88949' }}> 
      <div className="container">
        ...
        <div className="d-flex justify-content-between align-items-start flex-wrap">
          ...
          <div className="d-flex align-items-center">
            ...
            <a href="#" className="text-dark mx-1 fs-4"><FaGooglePlusG /></a>
            <a href="#" className="text-dark mx-1 fs-4"><FaFacebookF /></a>
            <a href="#" className="text-dark mx-1 fs-4"><FaLinkedinIn /></a>
            <a href="#" className="text-dark mx-1 fs-4"><FaTwitter /></a>
            <a href="#" className="text-dark mx-1 fs-4"><FaYoutube /></a>
            {/* Icon mail cuối cùng */}
            <a href="#" className="text-dark mx-1 fs-4"><MdMailOutline /></a> 
          </div>
